...
@follows(phasevariants,filtering,generate_patient_genome, patient_genome_index,countReads, mapReadsWithSTAR, buildSTARStats, loadSTARStats, loadReadCounts, buildBed)
def full():
    pass
